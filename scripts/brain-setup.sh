...
echo ""
echo "  Graduation brain-engine :"
echo "    Manuel   : bash scripts/brain-engine.sh start"
echo "    pm2      : bash scripts/brain-engine.sh install pm2"
echo "    systemd  : bash scripts/brain-engine.sh install systemd"
echo ""
